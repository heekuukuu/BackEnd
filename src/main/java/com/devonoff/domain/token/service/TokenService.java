package com.devonoff.domain.token.service;
...
public class TokenService {
  ...
  public String refreshAccessToken(String oldRefreshToken) {
    ...
    // 리프레시 토큰에서 사용자 이름 추출
    Long id = jwtTokenProvider.getUserIdFromToken(oldRefreshToken);
    ...
    Set<String> storedTokens = tokenRepository.getRefreshToken(String.valueOf(id));
    ...
    // 새롭게 생성된 액세스 토큰 반환
    return jwtTokenProvider.createAccessToken(String.valueOf(id));
  }
}